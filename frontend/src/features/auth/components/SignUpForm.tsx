  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 w-full">
        <h1 className="text-5xl md:text-5xl pt-1 font-bold text-[#1A1A1A] text-shadow-blue-800 tracking-tight mb-3">
          Create Account
        </h1>

        {/* 1. Name Input -> Enter goes to Email */}
        <div
          className="flex items-center gap-3 rounded-2xl border border-[#E0DDD6] bg-white px-4 h-[54px] shadow-sm transition-colors"
          style={{
            borderColor: focusedField === "name" ? "#5B8CFF" : "#E0DDD6",
            boxShadow: focusedField === "name" ? "0 0 0 2px #DCE8FF" : undefined,
          }}
        >
          <User size={18} className="shrink-0 text-[#6B6B6B]" />
        ...
        {/* 2. Email Input -> Enter goes to Password */}
        <div
          className="flex items-center gap-3 rounded-2xl border border-[#E0DDD6] bg-white px-4 h-[54px] shadow-sm transition-colors"
          style={{
